...
const policy_approve_box = document.getElementById("policy-approve-box");
const alim_approve_box = document.getElementById("alim-approve-box");
...
function policy_approve_box_close(){
    policy_approve_box.style.display = "none";
    alim_approve_box.style.display = "block";
}